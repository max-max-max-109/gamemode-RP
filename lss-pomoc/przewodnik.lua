...
function startup()
	window = guiCreateWindow(resX*1/10,resY*2/10,resX/10*8,resY/10*6,"null",false)
	guiSetVisible(window,false)
	guiWindowSetMovable(window,false)
	guiWindowSetSizable(window,false)
	tPanel = guiCreateTabPanel(0,0.1,1,1,true,window)
	local t1=guiCreateTab("null", tPanel)
--	guiCreateStaticImage ( 0.02, 0.04, 0.94, 0.4, "img/lss.png", true, t1 )
	...
	guiCreateLabel( 0.02, 0.70, 0.94, 0.20, "Testowanie", true, t1)
