...
function weaponDamage ( attacker, weapon, bodypart, loss )
	...
	if ( weapon == 23 and attacker ) then
		...
		cancelEvent()
	elseif ((weapon==24 or weapon==25 or weapon==28 or weapon==30 or weapon==29 or weapon==31 or weapon==22 or weapon==26 or weapon==34) and attacker) then -- deagle, uzi, ak47, mp5, m4, shotgun, glock
