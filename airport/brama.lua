...
local brama={}
brama.obiekt=createObject(969,1958.65,-2189.95,11.55,0,0,0)
setElementData(brama.obiekt,"customAction",{label="Otwórz/zamknij",resource="brama",funkcja="menu_brama",args={}})
...
brama.otworz=function()
    ...
    brama.animacja=true
    moveObject(brama.obiekt,5000,2885,1961.65,-2189.95,16.55,0,0,0,"OutBounce")
...
local function pracownik(id)
    local query=string.format("SELECT rank FROM lss_character_factions WHERE faction_id=99 AND character_id=%d", id)
