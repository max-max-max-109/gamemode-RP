...
--	archiwum w UM
	...
	{ 1468.02,-1785.88,1348.01,1,1,nazwa="Los Santos Airport", fid=99,minrank=3},
...
--    { 1144.28,-1813.55,1439.49,1,13,fid=7,minrank=7, nazwa="Taksówkarz" },
	...
	{ 1500.69,-2215.06,2191.83,2,45,nazwa="Los Santos Taxi", fid=100,minrank=7},
	...
	{ 1954.72,-2179.26,12.55,0,0,nazwa="Los Santos Airport", fid=99,minrank=3},
