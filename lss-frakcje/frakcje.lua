...
--	exports["lss-core"]:eq_giveItem(source, 26,1)
    ...
    elseif (factionid==100) then -- taxi
	exports["lss-core"]:eq_takeItem(source, 35)	-- pager
	exports["lss-core"]:eq_giveItem(source,35,1)
	exports["lss-core"]:eq_takeItem(source, 200)	-- klucze taxi
	exports["lss-core"]:eq_giveItem(source, 200,1)
    elseif (factionid==99) then -- Los Santos Aiport
	exports["lss-core"]:eq_takeItem(source, 201) -- klucze Airport
	exports["lss-core"]:eq_giveItem(source, 201,1)
	exports["lss-core"]:eq_takeItem(source, 41)	-- krotkofalowka
	exports["lss-core"]:eq_giveItem(source,41,1)
