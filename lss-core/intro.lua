...
local T_STOPKA="Forum-mta.cba.pl"
...
addEventHandler ( "onPlayerJoin", getRootElement(), function()
	...
	intro_watchers[source].serverText[1] = textCreateTextItem ( "Roleplay", 0.5, 0.1, 2, 255,255,255, 255, 3.0, "center", "center",127 )    -- create a text item for the display
